...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/slick-carousel/slick/slick.scss":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/slick-carousel/slick/slick-theme.scss":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"./ajax-loader.gif":[["ajax-loader.cc27c798.gif","../node_modules/slick-carousel/slick/ajax-loader.gif"],"../node_modules/slick-carousel/slick/ajax-loader.gif"],"./fonts/slick.eot":[["slick.964f802c.eot","../node_modules/slick-carousel/slick/fonts/slick.eot"],"../node_modules/slick-carousel/slick/fonts/slick.eot"],"./fonts/slick.woff":[["slick.9e7373ff.woff","../node_modules/slick-carousel/slick/fonts/slick.woff"],"../node_modules/slick-carousel/slick/fonts/slick.woff"],"./fonts/slick.ttf":[["slick.20ed192c.ttf","../node_modules/slick-carousel/slick/fonts/slick.ttf"],"../node_modules/slick-carousel/slick/fonts/slick.ttf"],"./fonts/slick.svg":[["slick.12cb16a7.svg","../node_modules/slick-carousel/slick/fonts/slick.svg"],"../node_modules/slick-carousel/slick/fonts/slick.svg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"vendor/custom_styleselect/custom_styleselect.js":[function(require,module,exports) {
var define;
...
(function (root, factory) {
  ...
  return function (selector) {
    ...
    // Включает кастомный селект на мобильных
    ...
    var realSelect = typeof selector == 'object' ? selector : query(selector),
        ...
        uuid = makeUUID(),
        styleSelectHTML = '<div class="style-select" aria-hidden="true" data-ss-uuid="' + uuid + '">'; // The index of the item that's being highlighted by the mouse or keyboard
...
var _custom_styleselect = _interopRequireDefault(require("../vendor/custom_styleselect/custom_styleselect"));
...
(0, _jquery.default)(() => {
  if (navigator.userAgent.indexOf("Firefox") != -1) {
    (0, _jquery.default)("body").addClass("firefox");
  }
  ...
  (0, _custom_styleselect.default)(".section-form__budget");
  (0, _custom_styleselect.default)(".section-form__position");
  (0, _jquery.default)(".section-form__input input").each(showHideInputPlaceholder).focusout(showHideInputPlaceholder).focusin(function () {
    (0, _jquery.default)(this).parent().addClass("section-form__input_hide-placeholder");
  });
  (0, _jquery.default)(".section-form__textarea").each(showHideSelectPlaceholder).focusout(showHideSelectPlaceholder).focusin(function () {
    (0, _jquery.default)(".section-form__textarea-wrapper").addClass("section-form__textarea-wrapper_hide-placeholder");
  });
  (0, _autosize.default)((0, _jquery.default)(".section-form__textarea"));

  function showHideInputPlaceholder() {
    const action = this.value ? "addClass" : "removeClass";
    (0, _jquery.default)(this).parent()[action]("section-form__input_hide-placeholder");
  }

  function showHideSelectPlaceholder() {
    const action = this.value ? "addClass" : "removeClass";
    (0, _jquery.default)(".section-form__textarea-wrapper")[action]("section-form__textarea-wrapper_hide-placeholder");
  }

  let form = (0, _jquery.default)(".section-form__form");
  form.on("submit", e => {
    e.preventDefault();
    ...
    _jquery.default.ajax({
      ...
      method: "POST",
      data: {
        name: (0, _jquery.default)("[name='name']", form).val(),
        email: (0, _jquery.default)("[name='email']", form).val(),
        budget: (0, _jquery.default)("[name='budget']", form).val(),
        position: (0, _jquery.default)("[name='position']", form).val(),
        message: (0, _jquery.default)("[name='message']", form).val()
      }
    }).done(() => {
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","slick-carousel":"../node_modules/slick-carousel/slick/slick.js","../../node_modules/slick-carousel/slick/slick.scss":"../node_modules/slick-carousel/slick/slick.scss","../../node_modules/slick-carousel/slick/slick-theme.scss":"../node_modules/slick-carousel/slick/slick-theme.scss","../vendor/custom_styleselect/custom_styleselect":"vendor/custom_styleselect/custom_styleselect.js","autosize":"../node_modules/autosize/dist/autosize.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
